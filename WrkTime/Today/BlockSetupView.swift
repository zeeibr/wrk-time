...
///
/// This carries both the pace choice and the aim-for-a-date switch, so the two
/// adjacent decisions on this screen are made with one control rather than a
/// switch stacked above a list of buttons. A filled square is also the same
